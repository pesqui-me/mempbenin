<x-admin-layout>
    ...
    <div class="page-header mb-4">
        <div class="row align-items-center">
            <div class="col">
                <h1 class="page-title mb-0">Nouveau Poste</h1>
    ...
    <form action="{{ route('admin.contenus.organigramme.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="position_title" required placeholder="Ex: Directeur des Enseignements">
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="department" placeholder="Ex: Cabinet du Ministre">
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Poste supérieur hiérarchique</label>
                            <select class="form-select" name="reports_to">
                                <option value="">Aucun (poste de niveau 1)</option>
                                <option value="1">Ministre</option>
                                <option value="2">Directeur de Cabinet</option>
                                <option value="3">Secrétaire Général</option>
                            </select>
                            <small class="text-muted">Sélectionnez le poste auquel celui-ci est rattaché</small>
                        </div>

                        <div class="mb-0">
                            <label class="form-label">Description du poste</label>
                            <textarea class="form-control" name="description" rows="4" placeholder="Responsabilités et missions principales du poste..."></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="alert alert-info">
                            ...
                            Laissez ces champs vides si le poste est vacant
                        </div>

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Nom complet</label>
                                <input type="text" class="form-control" name="holder_name" placeholder="Ex: Jean DUPONT">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Email</label>
                                <input type="email" class="form-control" name="holder_email" placeholder="j.dupont@memp.bj">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="holder_phone" placeholder="+229 XX XX XX XX">
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Date de nomination</label>
                                <input type="date" class="form-control" name="appointed_date">
                            </div>
                        </div>

                        <div class="mb-0">
                            <label class="form-label">Photo du titulaire</label>
